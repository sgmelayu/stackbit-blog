...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fe9102b02664a001516cef6
...
To start editing your site, you can use the Sanity interface at https://stackbit-blog-9102b.sanity.studio/.
...
Generated at `2020-12-27T22:55:53.817Z` by Stackbit version `0.3.41`.